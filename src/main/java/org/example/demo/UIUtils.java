...
public class UIUtils {
    ...
    public static void applyButtonEffects(Button btn, String hoverColor) {
        ...
        String defaultStyle = "-fx-background-color: #ecf0f1; -fx-text-fill: #34495e; -fx-font-weight: bold; -fx-font-size: 14px; -fx-background-radius: 8;";
        String hoverStyle = "-fx-background-color: " + hoverColor + "; -fx-text-fill: white; -fx-font-weight: bold; -fx-font-size: 14px; -fx-background-radius: 8;";
        ...
        btn.setOnMouseEntered(e -> {
            ...
            btn.setScaleY(1.1);
            ds.setRadius(15);
            // This is the Blue Glow you wanted
